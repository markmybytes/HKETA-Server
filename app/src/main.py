...
async def init_scheduler():
    ...
    @scheduler.scheduled_job(trigger='cron', args=['day'], hour='3', minute='15', max_instances=1)
    @scheduler.scheduled_job(trigger='cron', args=['night'], hour='15', minute='15', max_instances=1)
